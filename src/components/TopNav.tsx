...
import { Menu, X, LogOut, Wallet, UserCircle, MessageSquare, TrendingUp, ReceiptText, Zap, Banknote, History, Users } from 'lucide-react';
      ...
      <div className="flex items-center gap-4">
        {userData && (
          <div className="flex flex-col items-end max-w-[120px] sm:max-w-none">
            ...
            <span className="text-[10px] sm:text-sm font-black text-white italic tracking-tighter leading-none w-full text-right break-all">{formatCurrency(userData.balance)}</span>
          </div>
        )}
        <button 
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            >
              <div className="flex justify-between items-center text-white mt-6 px-1 shrink-0">
              ...
              <div className="flex flex-col gap-1 mt-4 overflow-y-auto flex-1 pr-1 scrollbar-hide">
                ...
                <MenuLink to="/referral" active={location.pathname === '/referral'} icon={<Users className="h-4 w-4" />} label="Referral" onClick={() => setIsOpen(false)} />
              ...
              <div className="mt-auto pb-6 pt-4 border-t border-white/5 shrink-0">
                <button
